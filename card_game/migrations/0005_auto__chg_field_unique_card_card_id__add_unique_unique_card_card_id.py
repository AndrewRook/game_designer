...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unique_Card.card_id'
        db.alter_column(u'card_game_unique_card', 'card_id_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['card_game.Card'], unique=True))
        # Adding unique constraint on 'Unique_Card', fields ['card_id']
        db.create_unique(u'card_game_unique_card', ['card_id_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Unique_Card', fields ['card_id']
        db.delete_unique(u'card_game_unique_card', ['card_id_id'])


        # Changing field 'Unique_Card.card_id'
        db.alter_column(u'card_game_unique_card', 'card_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card_game.Card']))
