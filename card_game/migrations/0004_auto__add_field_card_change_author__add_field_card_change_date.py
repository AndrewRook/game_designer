...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.change_author'
        db.add_column(u'card_game_card', 'change_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['user_control.UserProfile']),
                      keep_default=False)

        # Adding field 'Card.change_date'
        db.add_column(u'card_game_card', 'change_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.change_author'
        db.delete_column(u'card_game_card', 'change_author_id')

        # Deleting field 'Card.change_date'
        db.delete_column(u'card_game_card', 'change_date')
